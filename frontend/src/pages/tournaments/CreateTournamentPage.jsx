...
export default function CreateTournamentPage() {
  ...
  // Load existing tournaments to generate next ID
  ...
  // Auto-generate tournament ID e.g. TR-2026-013
  const nextId = useMemo(() => {
    const year = new Date().getFullYear();
    const count = tournaments.length + 1;
    ...
    <div className="management-page">
      ...
      <header className="mgmt-header">
        <div>
          ...
          <p>Set up a new volleyball tournament for teams, matches, and analytics</p>
        </div>
      </header>
      ...
      <div className="mgmt-tabs-nav">
        ...
        <Link to="/tournaments/create" className="mgmt-tab-btn active">
          Create Tournament
        </Link>
      </div>
